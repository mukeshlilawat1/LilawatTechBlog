...
const AdminStyles = () => (
  <style>{`
    ...
    .ad-toast {
      ...
      box-shadow: 0 8px 32px rgba(0,0,0,0.4); font-family: 'DM Sans', sans-serif;
      animation: ad-slidein 0.2s ease;
    }
    @keyframes ad-slidein { from { opacity:0; transform:translateX(16px); } to { opacity:1; transform:translateX(0); } }
    ...
    .ad-hero { border-bottom: 1px solid rgba(255,255,255,0.07); padding: 40px 24px 32px; position: relative; overflow: hidden; }
    ...
    .ad-hero-title { font-family: 'Bebas Neue', sans-serif; font-size: clamp(32px,6vw,52px); color: #f0f0ee; line-height: 1; margin-bottom: 6px; letter-spacing: 0.02em; }

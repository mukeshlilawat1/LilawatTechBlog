...
const AdminStyles = () => (
  <style>{`
    ...
    /* Buttons */
    .ad-action-btn { display: inline-flex; align-items: center; justify-content: center; gap: 6px; padding: 7px 12px; border-radius: 8px; font-size: 12px; font-weight: 700; cursor: pointer; transition: all 0.18s; font-family: 'DM Sans', sans-serif; text-decoration: none; border: 1px solid; width: 100%; box-sizing: border-box; }
    ...
    .ad-reject-label { font-family: 'DM Mono', monospace; font-size: 10px; letter-spacing: 0.12em; text-transform: uppercase; color: rgba(255,68,68,0.5); margin-bottom: 10px; }
...
const AdminDashboard: React.FC = () => {
  ...
  // Safe content preview — handles undefined/null content
